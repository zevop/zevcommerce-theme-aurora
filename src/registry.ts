// Import all Aurora section components and schemas
...
// Import shared functional sections from Prime
import { primeSectionRegistry } from '@zevcommerce/theme-prime';

export const auroraSectionRegistry: Record<string, { component: any; schema: any }> = {
  // Aurora-specific sections
